...
router.get('/getUser',function(req,res){
  ...
  var sql = "SELECT * FROM Drinkers WHERE Name= ? AND PhoneNum= ?";
  var filter = [req.query.name, req.query.phone];
...
var sql = "Select Bars.*, (Select count(LikeBeer.Beer)  From LikeBeer, SellBeers Where Drinkers.Name = LikeBeer.Name and SellBeers.Bar = Bars.Name and LikeBeer.Beer = SellBeers.Beer) as counter From Drinkers, Bars Where Drinkers.Name = ? and Drinkers.PhoneNum = ? and Drinkers.City = Bars.City Group by counter desc, Bars.Name";
...
var sql = "Select distinct ( (select count(*) From Plays Where Plays.bar = Bars.Name and Music = Plays.music) +  ((Select count(*) From BarTender, Employed Where Employed.bar = Bars.Name and Employed.bartender = BarTender.Name and BarTender.Personality = Drinkers.Personality) * 3) +  ((Select count(*) From SellBeers, LikeBeer Where SellBeers.Bar = Bars.Name and LikeBeer.Name = Drinkers.Name and SellBeers.Beer = LikeBeer.Beer) * 2) + ((Select count(*) Where Bars.Personality = Drinkers.Personality) * 3) ) as Matches, Bars.* From Drinkers, Bars Where Drinkers.name = ? and Drinkers.PhoneNum = ? and Drinkers.city = Bars.City  group by Matches desc, Bars.Name";
var filter = [req.query.Name, req.query.PhoneNum];
...
var sql = "Select Bars.*, SellBeers.Beer as Beers, SellBeers.Price as Price From Drinkers, Bars, LikeBeer, SellBeers Where Drinkers.Name = ? and Drinkers.PhoneNum = ? and Drinkers.City = Bars.City  and Drinkers.Name = LikeBeer.Name and SellBeers.Bar = Bars.Name and LikeBeer.Beer = SellBeers.Beer  group by Beers asc";
var filter = [req.query.Name, req.query.PhoneNum];
...
var sql = "Select (((select count(*) From Plays Where Plays.bar = Bars.Name and Drinkers.Music = Plays.music)) +  ((Select count(*) From BarTender, Employed Where Employed.bar = Bars.Name and Employed.bartender = BarTender.Name and BarTender.Personality = Drinkers.Personality) * 5) +  ((Select count(*) Where Bars.Personality = Drinkers.Personality) * 2) +  (round((Select sum(BarRating.rating) From BarRating Where BarRating.Bar = Bars.Name) / (Select count(*) From BarRating Where BarRating.Bar = Bars.Name)) * 2) ) as Matches, Bars.* From Drinkers, Bars Where Drinkers.name = ? and Drinkers.PhoneNum = ? and Drinkers.city = Bars.City  group by Matches desc, Bars.Name";
var filter = [req.query.Name, req.query.PhoneNum];
...
var sql = "Select(Select sum( (select count(*) From Plays Where Plays.bar = Bars.Name and Drinkers.Music = Plays.music) +  ((Select count(*) From BarTender, Employed Where Employed.bar = Bars.Name and Employed.bartender = BarTender.Name and BarTender.Personality = Drinkers.Personality) * 3) +  ((Select count(*) From SellBeers, LikeBeer Where SellBeers.Bar = Bars.Name and LikeBeer.Name = Drinkers.Name and SellBeers.Beer = LikeBeer.Beer) * 2) + ((Select count(*) Where Bars.Personality = Drinkers.Personality) * 3) + (round((Select sum(BarRating.rating) From BarRating Where BarRating.Bar = Bars.Name) / (Select count(*) From BarRating Where BarRating.Bar = Bars.Name)) * 2) ) From Drinkers Where Drinkers.city = d.City and Drinkers.Name != d.Name ) as Matches, Bars.* From Drinkers d, Bars Where d.name = ? and d.PhoneNum = ? and d.city = Bars.City  group by Matches desc, Bars.Name";
var filter = [req.query.Name, req.query.PhoneNum];
