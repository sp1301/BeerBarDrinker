...
@Component({
  selector: 'idealBarFinder',
  templateUrl: './idealBarFinder.component.html'
})
export class IdealBarFinder implements OnInit {
  ...
  constructor(         
    ...
    getNameandUser(): void {
        this.route.params.subscribe((params: Params) => {
            let user = params['userdetailideal'];
            ...
            this.webService.getIdealMatch(this.userFullDetail).subscribe(res => {
            this.Bars = res;
