...
@Component({
  selector: 'popBar',
  templateUrl: './popBar.component.html'
})
export class PopBar implements OnInit {
  ...
  constructor(         
    ...
    getNameandUser(): void {
        this.route.params.subscribe((params: Params) => {
            let user = params['userdetailpopbar'];
            ...
            this.webService.getPopularBar(this.userFullDetail).subscribe(res => {
            this.Bars = res;
